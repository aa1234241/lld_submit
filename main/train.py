...
parser.add_argument('--report-metrics', default=['acc', 'f1', 'kappa'],
...
def main():
    ...
    dataset_train = MultiPhaseLiverDatasetUpdate(args, is_training=True)

    dataset_eval = MultiPhaseLiverDatasetUpdate(args, is_training=False)
